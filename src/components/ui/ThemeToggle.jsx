...
export function ThemeToggle({ className }) {
  ...
  return (
    <button
      ...
      className={cn(
        'relative px-2.5 sm:px-3 py-1.5 rounded-xl border text-xs font-black transition-all duration-200 cursor-pointer select-none flex items-center gap-1.5 shadow-xs',
        isDark
